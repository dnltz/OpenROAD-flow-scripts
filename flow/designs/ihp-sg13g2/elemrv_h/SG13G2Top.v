...
// Component : SG13G2Top
// Git hash  : 9e8e742f55987109a020ef830ab4689393993db7
...
module SG13G2Top (
  ...
  reg        [11:0]   soc_io_pins_pins_read;
  ...
  wire       [11:0]   soc_io_pins_pins_write;
  wire       [11:0]   soc_io_pins_pins_writeEnable;
  ...
  ElemRV soc (
    ...
    .io_pins_pins_read          (soc_io_pins_pins_read[11:0]        ), //i
    .io_pins_pins_write         (soc_io_pins_pins_write[11:0]       ), //o
    .io_pins_pins_writeEnable   (soc_io_pins_pins_writeEnable[11:0] )  //o
  );
...
module ElemRV (
  ...
  reg        [11:0]   peripherals_gpio0Ctrl_io_gpio_pins_read;
  ...
  reg        [23:0]   peripherals_pinmuxCtrl_io_inputs_write;
  reg        [23:0]   peripherals_pinmuxCtrl_io_inputs_writeEnable;
  ...
  wire       [11:0]   peripherals_gpio0Ctrl_io_gpio_pins_write;
  wire       [11:0]   peripherals_gpio0Ctrl_io_gpio_pins_writeEnable;
  ...
  wire       [11:0]   peripherals_pinmuxCtrl_io_pins_pins_write;
  wire       [11:0]   peripherals_pinmuxCtrl_io_pins_pins_writeEnable;
  wire       [23:0]   peripherals_pinmuxCtrl_io_inputs_read;
  ...
  Axi4SharedOnChipRam system_onChipCtrl (
  ...
  Apb3Gpio peripherals_gpio0Ctrl (
    ...
    .io_gpio_pins_read        (peripherals_gpio0Ctrl_io_gpio_pins_read[11:0]       ), //i
    .io_gpio_pins_write       (peripherals_gpio0Ctrl_io_gpio_pins_write[11:0]      ), //o
    .io_gpio_pins_writeEnable (peripherals_gpio0Ctrl_io_gpio_pins_writeEnable[11:0]), //o
  ...
  Apb3Pinmux peripherals_pinmuxCtrl (
    ...
    .io_pins_pins_read        (io_pins_pins_read[11:0]                              ), //i
    .io_pins_pins_write       (peripherals_pinmuxCtrl_io_pins_pins_write[11:0]      ), //o
    .io_pins_pins_writeEnable (peripherals_pinmuxCtrl_io_pins_pins_writeEnable[11:0]), //o
    .io_inputs_read           (peripherals_pinmuxCtrl_io_inputs_read[23:0]          ), //o
    .io_inputs_write          (peripherals_pinmuxCtrl_io_inputs_write[23:0]         ), //i
    .io_inputs_writeEnable    (peripherals_pinmuxCtrl_io_inputs_writeEnable[23:0]   ), //i
    ._zz_1                    (clockCtrl__zz_3                                      ), //i
    ._zz_2                    (resetCtrl__zz_3                                      )  //i
  );
  Apb3Decoder io_apb_decoder (
    ...
    .io_output_PSEL      (io_apb_decoder_io_output_PSEL[10:0]  ), //o
  ...
  Apb3Router apb3Router_1 (
    ...
    .io_input_PSEL           (io_apb_decoder_io_output_PSEL[10:0]            ), //i
    ...
    .io_outputs_4_PREADY     (system_spiXipControllerCtrl_io_bus_PREADY      ), //i
    .io_outputs_4_PWRITE     (apb3Router_1_io_outputs_4_PWRITE               ), //o
    .io_outputs_4_PWDATA     (apb3Router_1_io_outputs_4_PWDATA[31:0]         ), //o
    .io_outputs_4_PRDATA     (system_spiXipControllerCtrl_io_bus_PRDATA[31:0]), //i
    .io_outputs_4_PSLVERROR  (system_spiXipControllerCtrl_io_bus_PSLVERROR   ), //i
    ...
    .io_outputs_5_PREADY     (peripherals_gpio0Ctrl_io_bus_PREADY            ), //i
    .io_outputs_5_PWRITE     (apb3Router_1_io_outputs_5_PWRITE               ), //o
    .io_outputs_5_PWDATA     (apb3Router_1_io_outputs_5_PWDATA[31:0]         ), //o
    .io_outputs_5_PRDATA     (peripherals_gpio0Ctrl_io_bus_PRDATA[31:0]      ), //i
    .io_outputs_5_PSLVERROR  (peripherals_gpio0Ctrl_io_bus_PSLVERROR         ), //i
    ...
    .io_outputs_6_PREADY     (peripherals_i2c0Ctrl_io_bus_PREADY             ), //i
    .io_outputs_6_PWRITE     (apb3Router_1_io_outputs_6_PWRITE               ), //o
    .io_outputs_6_PWDATA     (apb3Router_1_io_outputs_6_PWDATA[31:0]         ), //o
    .io_outputs_6_PRDATA     (peripherals_i2c0Ctrl_io_bus_PRDATA[31:0]       ), //i
    .io_outputs_6_PSLVERROR  (peripherals_i2c0Ctrl_io_bus_PSLVERROR          ), //i
    ...
    .io_outputs_7_PREADY     (peripherals_pio0Ctrl_io_bus_PREADY             ), //i
    .io_outputs_7_PWRITE     (apb3Router_1_io_outputs_7_PWRITE               ), //o
    .io_outputs_7_PWDATA     (apb3Router_1_io_outputs_7_PWDATA[31:0]         ), //o
    .io_outputs_7_PRDATA     (peripherals_pio0Ctrl_io_bus_PRDATA[31:0]       ), //i
    .io_outputs_7_PSLVERROR  (peripherals_pio0Ctrl_io_bus_PSLVERROR          ), //i
    ...
    .io_outputs_8_PREADY     (peripherals_pwm0Ctrl_io_bus_PREADY             ), //i
    .io_outputs_8_PWRITE     (apb3Router_1_io_outputs_8_PWRITE               ), //o
    .io_outputs_8_PWDATA     (apb3Router_1_io_outputs_8_PWDATA[31:0]         ), //o
    .io_outputs_8_PRDATA     (peripherals_pwm0Ctrl_io_bus_PRDATA[31:0]       ), //i
    .io_outputs_8_PSLVERROR  (peripherals_pwm0Ctrl_io_bus_PSLVERROR          ), //i
    ...
    .io_outputs_9_PREADY     (peripherals_uart0Ctrl_io_bus_PREADY            ), //i
    .io_outputs_9_PWRITE     (apb3Router_1_io_outputs_9_PWRITE               ), //o
    .io_outputs_9_PWDATA     (apb3Router_1_io_outputs_9_PWDATA[31:0]         ), //o
    .io_outputs_9_PRDATA     (peripherals_uart0Ctrl_io_bus_PRDATA[31:0]      ), //i
    .io_outputs_9_PSLVERROR  (peripherals_uart0Ctrl_io_bus_PSLVERROR         ), //i
    ...
    .io_outputs_10_PREADY    (peripherals_pinmuxCtrl_io_bus_PREADY           ), //i
    .io_outputs_10_PWRITE    (apb3Router_1_io_outputs_10_PWRITE              ), //o
    .io_outputs_10_PWDATA    (apb3Router_1_io_outputs_10_PWDATA[31:0]        ), //o
    .io_outputs_10_PRDATA    (peripherals_pinmuxCtrl_io_bus_PRDATA[31:0]     ), //i
    .io_outputs_10_PSLVERROR (peripherals_pinmuxCtrl_io_bus_PSLVERROR        ), //i
    ._zz_1                   (clockCtrl__zz_3                                ), //i
    ._zz_2                   (resetCtrl__zz_3                                )  //i
  );
  always @(*) begin
  ...
  assign when_Stream_l375_8 = (! soc_system_spiXipControllerCtrl_io_dataBus_arbiter_io_output_ar_s2mPipe_m2sPipe_valid);
  ...
  assign when_Stream_l375_9 = (! soc_system_spiXipControllerCtrl_io_dataBus_r_s2mPipe_m2sPipe_valid);
  ...
  assign system_apbBridge_io_axi_arbiter_io_sharedInputs_0_arw_payload_addr = soc_axi4SharedDecoder_1_io_sharedOutputs_1_arw_validPipe_payload_addr[23:0];
  ...
  assign peripherals_i2c0Ctrl_io_i2c_scl_read = peripherals_pinmuxCtrl_io_inputs_read[12];
  assign peripherals_i2c0Ctrl_io_i2c_sda_read = peripherals_pinmuxCtrl_io_inputs_read[13];
  assign peripherals_i2c0Ctrl_io_i2c_interrupts[0] = peripherals_pinmuxCtrl_io_inputs_read[14];
  always @(*) begin
    peripherals_pio0Ctrl_io_pio_pins_read[0] = peripherals_pinmuxCtrl_io_inputs_read[15];
    peripherals_pio0Ctrl_io_pio_pins_read[1] = peripherals_pinmuxCtrl_io_inputs_read[16];
    peripherals_pio0Ctrl_io_pio_pins_read[2] = peripherals_pinmuxCtrl_io_inputs_read[17];
  end

  assign peripherals_uart0Ctrl_io_uart_rxd = peripherals_pinmuxCtrl_io_inputs_read[21];
  assign peripherals_uart0Ctrl_io_uart_cts = peripherals_pinmuxCtrl_io_inputs_read[22];
  ...
  always @(*) begin
    ...
    peripherals_pinmuxCtrl_io_inputs_write[14] = 1'b0;
    ...
    peripherals_pinmuxCtrl_io_inputs_write[19] = peripherals_pwm0Ctrl_io_pwm_output[1];
    peripherals_pinmuxCtrl_io_inputs_write[17] = peripherals_pio0Ctrl_io_pio_pins_write[2];
    ...
    peripherals_pinmuxCtrl_io_inputs_write[12] = peripherals_i2c0Ctrl_io_i2c_scl_write;
    peripherals_pinmuxCtrl_io_inputs_write[8] = peripherals_gpio0Ctrl_io_gpio_pins_write[8];
    peripherals_pinmuxCtrl_io_inputs_write[21] = 1'b0;
    ...
    peripherals_pinmuxCtrl_io_inputs_write[18] = peripherals_pwm0Ctrl_io_pwm_output[0];
    peripherals_pinmuxCtrl_io_inputs_write[16] = peripherals_pio0Ctrl_io_pio_pins_write[1];
    peripherals_pinmuxCtrl_io_inputs_write[20] = peripherals_uart0Ctrl_io_uart_txd;
    peripherals_pinmuxCtrl_io_inputs_write[15] = peripherals_pio0Ctrl_io_pio_pins_write[0];
    ...
    peripherals_pinmuxCtrl_io_inputs_write[13] = peripherals_i2c0Ctrl_io_i2c_sda_write;
    ...
    peripherals_pinmuxCtrl_io_inputs_write[23] = peripherals_uart0Ctrl_io_uart_rts;
  end

  always @(*) begin
    peripherals_pinmuxCtrl_io_inputs_writeEnable[22] = 1'b0;
    peripherals_pinmuxCtrl_io_inputs_writeEnable[14] = 1'b0;
    ...
    peripherals_pinmuxCtrl_io_inputs_writeEnable[19] = 1'b1;
    peripherals_pinmuxCtrl_io_inputs_writeEnable[17] = peripherals_pio0Ctrl_io_pio_pins_writeEnable[2];
    ...
    peripherals_pinmuxCtrl_io_inputs_writeEnable[12] = 1'b0;
    ...
    peripherals_pinmuxCtrl_io_inputs_writeEnable[18] = 1'b1;
    peripherals_pinmuxCtrl_io_inputs_writeEnable[16] = peripherals_pio0Ctrl_io_pio_pins_writeEnable[1];
    peripherals_pinmuxCtrl_io_inputs_writeEnable[20] = 1'b1;
    peripherals_pinmuxCtrl_io_inputs_writeEnable[15] = peripherals_pio0Ctrl_io_pio_pins_writeEnable[0];
    ...
    peripherals_pinmuxCtrl_io_inputs_writeEnable[13] = 1'b0;
    ...
    peripherals_pinmuxCtrl_io_inputs_writeEnable[23] = 1'b1;
  end
  ...
  assign system_spiXipControllerCtrl_io_bus_PADDR = apb3Router_1_io_outputs_4_PADDR[11:0];
  assign peripherals_gpio0Ctrl_io_bus_PADDR = apb3Router_1_io_outputs_5_PADDR[11:0];
  assign peripherals_i2c0Ctrl_io_bus_PADDR = apb3Router_1_io_outputs_6_PADDR[11:0];
  assign peripherals_pio0Ctrl_io_bus_PADDR = apb3Router_1_io_outputs_7_PADDR[11:0];
  assign peripherals_pwm0Ctrl_io_bus_PADDR = apb3Router_1_io_outputs_8_PADDR[11:0];
  assign peripherals_uart0Ctrl_io_bus_PADDR = apb3Router_1_io_outputs_9_PADDR[11:0];
  assign peripherals_pinmuxCtrl_io_bus_PADDR = apb3Router_1_io_outputs_10_PADDR[11:0];
  always @(*) begin
    ...
    system_plicCtrl_io_sources[2] = peripherals_uart0Ctrl_io_interrupt;
  end
...
module Apb3Router (
  ...
  assign _zz_selIndex_6 = ((((io_input_PSEL[1] || _zz_selIndex) || _zz_selIndex_1) || _zz_selIndex_3) || _zz_selIndex_4);
  assign _zz_selIndex_7 = ((((io_input_PSEL[2] || _zz_selIndex) || _zz_selIndex_2) || _zz_selIndex_3) || _zz_selIndex_5);
  assign _zz_selIndex_8 = (((io_input_PSEL[4] || _zz_selIndex_1) || _zz_selIndex_2) || _zz_selIndex_3);
  assign _zz_selIndex_9 = ((io_input_PSEL[8] || _zz_selIndex_4) || _zz_selIndex_5);
  assign io_input_PREADY = _zz_io_input_PREADY;
  assign io_input_PRDATA = _zz_io_input_PRDATA;
  assign io_input_PSLVERROR = _zz_io_input_PSLVERROR;
  always @(posedge _zz_1) begin
    selIndex <= {_zz_selIndex_9,{_zz_selIndex_8,{_zz_selIndex_7,_zz_selIndex_6}}};
  end
...
module Apb3Decoder (
  ...
  always @(*) begin
    ...
    io_output_PSEL[4] = (((io_input_PADDR & (~ 24'h000fff)) == 24'h024000) && io_input_PSEL[0]);
    io_output_PSEL[5] = (((io_input_PADDR & (~ 24'h000fff)) == 24'h0) && io_input_PSEL[0]);
    io_output_PSEL[6] = (((io_input_PADDR & (~ 24'h000fff)) == 24'h001000) && io_input_PSEL[0]);
    io_output_PSEL[7] = (((io_input_PADDR & (~ 24'h000fff)) == 24'h002000) && io_input_PSEL[0]);
    io_output_PSEL[8] = (((io_input_PADDR & (~ 24'h000fff)) == 24'h003000) && io_input_PSEL[0]);
    io_output_PSEL[9] = (((io_input_PADDR & (~ 24'h000fff)) == 24'h004000) && io_input_PSEL[0]);
    io_output_PSEL[10] = (((io_input_PADDR & (~ 24'h000fff)) == 24'h010000) && io_input_PSEL[0]);
  end
  ...
  assign when_Apb3Decoder_l88 = (io_input_PSEL[0] && (io_output_PSEL == 11'h0));
...
module Apb3Uart (
  ...
  reg        [1:0]    interruptCtrl_6_io_inputs;
  reg        [1:0]    interruptCtrl_6_io_clears;
  ...
  wire       [1:0]    interruptCtrl_6_io_pendings;
  ...
  reg        [1:0]    peripherals_uart0Ctrl_interruptCtrl_6_io_masks_driver;
  ...
  UartCtrl ctrl (
    ...
    .io_pendingInterrupts         (interruptCtrl_6_io_pendings[1:0]                                   ), //i
  ...
  StreamFifo peripherals_uart0Ctrl_ctrl_io_read_queueWithOccupancy (
  ...
  InterruptCtrl interruptCtrl_6 (
    .io_inputs   (interruptCtrl_6_io_inputs[1:0]                            ), //i
    .io_clears   (interruptCtrl_6_io_clears[1:0]                            ), //i
    .io_masks    (peripherals_uart0Ctrl_interruptCtrl_6_io_masks_driver[1:0]), //i
    .io_pendings (interruptCtrl_6_io_pendings[1:0]                          ), //o
    ._zz_1       (_zz_1                                                     ), //i
    ._zz_2       (_zz_2                                                     )  //i
  );
  `ifndef SYNTHESIS
  ...
  always @(*) begin
    ...
    case(io_bus_PADDR)
      ...
      12'h02c : begin
        io_bus_PRDATA[1 : 0] = interruptCtrl_6_io_pendings;
      end
      12'h030 : begin
        io_bus_PRDATA[1 : 0] = peripherals_uart0Ctrl_interruptCtrl_6_io_masks_driver;
      end
      default : begin
      end
    endcase
  ...
  always @(*) begin
    interruptCtrl_6_io_clears = 2'b00;
    case(io_bus_PADDR)
      12'h02c : begin
        if(_zz_io_bus_PSLVERROR_2) begin
          interruptCtrl_6_io_clears = io_bus_PWDATA[1 : 0];
        end
      end
      default : begin
      end
  ...
  always @(*) begin
    interruptCtrl_6_io_inputs[0] = ((mapper_tx_streamUnbuffered_queueWithOccupancy_io_occupancy == _zz_io_bus_PRDATA) && (peripherals_uart0Ctrl_mapper_tx_streamUnbuffered_queueWithOccupancy_io_occupancy_regNext == _zz_io_inputs));
    interruptCtrl_6_io_inputs[1] = ctrl_io_read_valid;
  end
  ...
  always @(posedge _zz_1) begin
    if(!_zz_2) begin
      ...
      peripherals_uart0Ctrl_interruptCtrl_6_io_masks_driver <= 2'b00;
    end else begin
      case(io_bus_PADDR)
        12'h020 : begin
          if(_zz_io_bus_PSLVERROR_2) begin
        ...
        12'h030 : begin
          if(_zz_io_bus_PSLVERROR_2) begin
            peripherals_uart0Ctrl_interruptCtrl_6_io_masks_driver <= io_bus_PWDATA[1 : 0];
          end
        end
        default : begin
        end
...
module Apb3Pwm (
  ...
  IpIdentificationCtrl_1 mapper_idCtrl (
    .io_header  (mapper_idCtrl_io_header[31:0] ), //o
    .io_version (mapper_idCtrl_io_version[31:0]), //o
    ._zz_1      (_zz_1                         ), //i
    ._zz_2      (_zz_2                         )  //i
...
module Apb3Pio (
  ...
  StreamFifo_2 mapper_tx_streamUnbuffered_queueWithOccupancy (
    .io_push_valid           (mapper_tx_streamUnbuffered_valid                                         ), //i
    .io_push_ready           (mapper_tx_streamUnbuffered_queueWithOccupancy_io_push_ready              ), //o
  ...
  StreamFifo_3 peripherals_pio0Ctrl_ctrl_io_read_queueWithOccupancy (
    .io_push_valid          (ctrl_io_read_valid                                                        ), //i
...
module Apb3I2cController (
  ...
  reg                 peripherals_i2c0Ctrl_i2cControllerCtrl_1_io_rsp_queueWithOccupancy_io_pop_ready;
  ...
  wire                peripherals_i2c0Ctrl_i2cControllerCtrl_1_io_rsp_queueWithOccupancy_io_push_ready;
  wire                peripherals_i2c0Ctrl_i2cControllerCtrl_1_io_rsp_queueWithOccupancy_io_pop_valid;
  wire       [7:0]    peripherals_i2c0Ctrl_i2cControllerCtrl_1_io_rsp_queueWithOccupancy_io_pop_payload_data;
  wire                peripherals_i2c0Ctrl_i2cControllerCtrl_1_io_rsp_queueWithOccupancy_io_pop_payload_error;
  wire       [4:0]    peripherals_i2c0Ctrl_i2cControllerCtrl_1_io_rsp_queueWithOccupancy_io_occupancy;
  wire       [4:0]    peripherals_i2c0Ctrl_i2cControllerCtrl_1_io_rsp_queueWithOccupancy_io_availability;
  ...
  I2cControllerCtrl i2cControllerCtrl_1 (
    ...
    .io_rsp_ready                 (peripherals_i2c0Ctrl_i2cControllerCtrl_1_io_rsp_queueWithOccupancy_io_push_ready), //i
  ...
  IpIdentificationCtrl_3 mapper_idCtrl (
    .io_header  (mapper_idCtrl_io_header[31:0] ), //o
    .io_version (mapper_idCtrl_io_version[31:0]), //o
    ._zz_1      (_zz_1                         ), //i
    ._zz_2      (_zz_2                         )  //i
  );
  StreamFifo_4 mapper_cmdLogic_streamUnbuffered_queueWithOccupancy (
  ...
  StreamFifo_5 peripherals_i2c0Ctrl_i2cControllerCtrl_1_io_rsp_queueWithOccupancy (
    .io_push_valid         (i2cControllerCtrl_1_io_rsp_valid                                                           ), //i
    .io_push_ready         (peripherals_i2c0Ctrl_i2cControllerCtrl_1_io_rsp_queueWithOccupancy_io_push_ready           ), //o
    ...
    .io_pop_valid          (peripherals_i2c0Ctrl_i2cControllerCtrl_1_io_rsp_queueWithOccupancy_io_pop_valid            ), //o
    .io_pop_ready          (peripherals_i2c0Ctrl_i2cControllerCtrl_1_io_rsp_queueWithOccupancy_io_pop_ready            ), //i
    .io_pop_payload_data   (peripherals_i2c0Ctrl_i2cControllerCtrl_1_io_rsp_queueWithOccupancy_io_pop_payload_data[7:0]), //o
    .io_pop_payload_error  (peripherals_i2c0Ctrl_i2cControllerCtrl_1_io_rsp_queueWithOccupancy_io_pop_payload_error    ), //o
    .io_flush              (1'b0                                                                                       ), //i
    .io_occupancy          (peripherals_i2c0Ctrl_i2cControllerCtrl_1_io_rsp_queueWithOccupancy_io_occupancy[4:0]       ), //o
    .io_availability       (peripherals_i2c0Ctrl_i2cControllerCtrl_1_io_rsp_queueWithOccupancy_io_availability[4:0]    ), //o
    ._zz_4                 (_zz_1                                                                                      ), //i
    ._zz_5                 (_zz_2                                                                                      )  //i
  );
  InterruptCtrl_1 mapper_interruptCtrl_irqCtrl (
  ...
  always @(*) begin
    ...
    case(io_bus_PADDR)
      ...
      12'h014 : begin
        io_bus_PRDATA[31 : 31] = (peripherals_i2c0Ctrl_i2cControllerCtrl_1_io_rsp_queueWithOccupancy_io_pop_valid ^ 1'b0);
        io_bus_PRDATA[8 : 0] = {peripherals_i2c0Ctrl_i2cControllerCtrl_1_io_rsp_queueWithOccupancy_io_pop_payload_error,peripherals_i2c0Ctrl_i2cControllerCtrl_1_io_rsp_queueWithOccupancy_io_pop_payload_data};
      end
      12'h018 : begin
        io_bus_PRDATA[20 : 16] = mapper_cmdLogic_fifoVacancy;
        io_bus_PRDATA[4 : 0] = peripherals_i2c0Ctrl_i2cControllerCtrl_1_io_rsp_queueWithOccupancy_io_occupancy;
      end
      12'h01c : begin
  ...
  always @(*) begin
    peripherals_i2c0Ctrl_i2cControllerCtrl_1_io_rsp_queueWithOccupancy_io_pop_ready = 1'b0;
    case(io_bus_PADDR)
      12'h014 : begin
        if(_zz_io_bus_PSLVERROR_3) begin
          peripherals_i2c0Ctrl_i2cControllerCtrl_1_io_rsp_queueWithOccupancy_io_pop_ready = 1'b1;
        end
      end
      default : begin
      end
  ...
  always @(*) begin
    ...
    mapper_interruptCtrl_irqCtrl_io_inputs[1] = peripherals_i2c0Ctrl_i2cControllerCtrl_1_io_rsp_queueWithOccupancy_io_pop_valid;
...
module Apb3Gpio (
  ...
  reg        [11:0]   interruptCtrl_8_io_inputs;
  reg        [11:0]   interruptCtrl_8_io_clears;
  reg        [11:0]   interruptCtrl_9_io_inputs;
  reg        [11:0]   interruptCtrl_9_io_clears;
  ...
  wire       [11:0]   interruptCtrl_8_io_pendings;
  wire       [11:0]   interruptCtrl_9_io_pendings;
  wire                _zz_io_bus_PSLVERROR;
  wire                _zz_io_bus_PSLVERROR_1;
  wire                _zz_io_bus_PSLVERROR_2;
  wire                _zz_io_bus_PSLVERROR_3;
  reg        [11:0]   peripherals_gpio0Ctrl_interruptCtrl_6_io_masks_driver;
  reg        [11:0]   peripherals_gpio0Ctrl_interruptCtrl_7_io_masks_driver;
  reg        [11:0]   peripherals_gpio0Ctrl_interruptCtrl_8_io_masks_driver;
  reg        [11:0]   peripherals_gpio0Ctrl_interruptCtrl_9_io_masks_driver;
  ...
  InterruptCtrl_2 interruptCtrl_6 (
    .io_inputs   (interruptCtrl_6_io_inputs[11:0]                            ), //i
    .io_clears   (interruptCtrl_6_io_clears[11:0]                            ), //i
    .io_masks    (peripherals_gpio0Ctrl_interruptCtrl_6_io_masks_driver[11:0]), //i
    .io_pendings (interruptCtrl_6_io_pendings[11:0]                          ), //o
    ._zz_1       (_zz_1                                                      ), //i
    ._zz_2       (_zz_2                                                      )  //i
  );
  InterruptCtrl_2 interruptCtrl_7 (
    .io_inputs   (interruptCtrl_7_io_inputs[11:0]                            ), //i
    .io_clears   (interruptCtrl_7_io_clears[11:0]                            ), //i
    .io_masks    (peripherals_gpio0Ctrl_interruptCtrl_7_io_masks_driver[11:0]), //i
    .io_pendings (interruptCtrl_7_io_pendings[11:0]                          ), //o
    ._zz_1       (_zz_1                                                      ), //i
    ._zz_2       (_zz_2                                                      )  //i
  );
  InterruptCtrl_2 interruptCtrl_8 (
    .io_inputs   (interruptCtrl_8_io_inputs[11:0]                            ), //i
    .io_clears   (interruptCtrl_8_io_clears[11:0]                            ), //i
    .io_masks    (peripherals_gpio0Ctrl_interruptCtrl_8_io_masks_driver[11:0]), //i
    .io_pendings (interruptCtrl_8_io_pendings[11:0]                          ), //o
    ._zz_1       (_zz_1                                                      ), //i
    ._zz_2       (_zz_2                                                      )  //i
  );
  InterruptCtrl_2 interruptCtrl_9 (
    .io_inputs   (interruptCtrl_9_io_inputs[11:0]                            ), //i
    .io_clears   (interruptCtrl_9_io_clears[11:0]                            ), //i
    .io_masks    (peripherals_gpio0Ctrl_interruptCtrl_9_io_masks_driver[11:0]), //i
    .io_pendings (interruptCtrl_9_io_pendings[11:0]                          ), //o
    ._zz_1       (_zz_1                                                      ), //i
    ._zz_2       (_zz_2                                                      )  //i
  );
  ...
  always @(*) begin
    ...
    case(io_bus_PADDR)
      ...
      12'h008 : begin
        io_bus_PRDATA[31 : 0] = {16'h0001,16'h000c};
      end
      12'h018 : begin
        io_bus_PRDATA[11 : 0] = interruptCtrl_6_io_pendings;
      end
      12'h01c : begin
        io_bus_PRDATA[11 : 0] = peripherals_gpio0Ctrl_interruptCtrl_6_io_masks_driver;
      end
      12'h020 : begin
        io_bus_PRDATA[11 : 0] = interruptCtrl_7_io_pendings;
      end
      12'h024 : begin
        io_bus_PRDATA[11 : 0] = peripherals_gpio0Ctrl_interruptCtrl_7_io_masks_driver;
      end
      12'h028 : begin
        io_bus_PRDATA[11 : 0] = interruptCtrl_8_io_pendings;
      end
      12'h02c : begin
        io_bus_PRDATA[11 : 0] = peripherals_gpio0Ctrl_interruptCtrl_8_io_masks_driver;
      end
      12'h030 : begin
        io_bus_PRDATA[11 : 0] = interruptCtrl_9_io_pendings;
      end
      12'h034 : begin
        io_bus_PRDATA[11 : 0] = peripherals_gpio0Ctrl_interruptCtrl_9_io_masks_driver;
      end
      12'h00c : begin
  ...
  always @(*) begin
    ...
    case(io_bus_PADDR)
      12'h018 : begin
        if(_zz_io_bus_PSLVERROR_2) begin
          interruptCtrl_6_io_clears = io_bus_PWDATA[11 : 0];
        end
      end
      default : begin
      end
  ...
  always @(*) begin
    ...
    case(io_bus_PADDR)
      12'h020 : begin
        if(_zz_io_bus_PSLVERROR_2) begin
          interruptCtrl_7_io_clears = io_bus_PWDATA[11 : 0];
        end
      end
      default : begin
      end
  ...
  always @(*) begin
    interruptCtrl_8_io_clears = 12'h0;
    case(io_bus_PADDR)
      12'h028 : begin
        if(_zz_io_bus_PSLVERROR_2) begin
          interruptCtrl_8_io_clears = io_bus_PWDATA[11 : 0];
        end
      end
      default : begin
      end
  ...
  always @(*) begin
    interruptCtrl_9_io_clears = 12'h0;
    case(io_bus_PADDR)
      12'h030 : begin
        if(_zz_io_bus_PSLVERROR_2) begin
          interruptCtrl_9_io_clears = io_bus_PWDATA[11 : 0];
        end
      end
      default : begin
      end
  ...
  always @(*) begin
    interruptCtrl_6_io_inputs[0] = ctrl_io_irqHigh_valid[0];
    interruptCtrl_6_io_inputs[1] = ctrl_io_irqHigh_valid[1];
    interruptCtrl_6_io_inputs[2] = ctrl_io_irqHigh_valid[2];
    interruptCtrl_6_io_inputs[3] = ctrl_io_irqHigh_valid[3];
    interruptCtrl_6_io_inputs[4] = ctrl_io_irqHigh_valid[4];
    interruptCtrl_6_io_inputs[5] = ctrl_io_irqHigh_valid[5];
    interruptCtrl_6_io_inputs[6] = ctrl_io_irqHigh_valid[6];
    interruptCtrl_6_io_inputs[7] = ctrl_io_irqHigh_valid[7];
    interruptCtrl_6_io_inputs[8] = ctrl_io_irqHigh_valid[8];
    interruptCtrl_6_io_inputs[9] = ctrl_io_irqHigh_valid[9];
    interruptCtrl_6_io_inputs[10] = ctrl_io_irqHigh_valid[10];
    interruptCtrl_6_io_inputs[11] = ctrl_io_irqHigh_valid[11];
  end

  always @(*) begin
    interruptCtrl_7_io_inputs[0] = ctrl_io_irqLow_valid[0];
    interruptCtrl_7_io_inputs[1] = ctrl_io_irqLow_valid[1];
    interruptCtrl_7_io_inputs[2] = ctrl_io_irqLow_valid[2];
    interruptCtrl_7_io_inputs[3] = ctrl_io_irqLow_valid[3];
    interruptCtrl_7_io_inputs[4] = ctrl_io_irqLow_valid[4];
    interruptCtrl_7_io_inputs[5] = ctrl_io_irqLow_valid[5];
    interruptCtrl_7_io_inputs[6] = ctrl_io_irqLow_valid[6];
    interruptCtrl_7_io_inputs[7] = ctrl_io_irqLow_valid[7];
    interruptCtrl_7_io_inputs[8] = ctrl_io_irqLow_valid[8];
    interruptCtrl_7_io_inputs[9] = ctrl_io_irqLow_valid[9];
    interruptCtrl_7_io_inputs[10] = ctrl_io_irqLow_valid[10];
    interruptCtrl_7_io_inputs[11] = ctrl_io_irqLow_valid[11];
  end

  always @(*) begin
    interruptCtrl_8_io_inputs[0] = ctrl_io_irqRise_valid[0];
    interruptCtrl_8_io_inputs[1] = ctrl_io_irqRise_valid[1];
    interruptCtrl_8_io_inputs[2] = ctrl_io_irqRise_valid[2];
    interruptCtrl_8_io_inputs[3] = ctrl_io_irqRise_valid[3];
    interruptCtrl_8_io_inputs[4] = ctrl_io_irqRise_valid[4];
    interruptCtrl_8_io_inputs[5] = ctrl_io_irqRise_valid[5];
    interruptCtrl_8_io_inputs[6] = ctrl_io_irqRise_valid[6];
    interruptCtrl_8_io_inputs[7] = ctrl_io_irqRise_valid[7];
    interruptCtrl_8_io_inputs[8] = ctrl_io_irqRise_valid[8];
    interruptCtrl_8_io_inputs[9] = ctrl_io_irqRise_valid[9];
    interruptCtrl_8_io_inputs[10] = ctrl_io_irqRise_valid[10];
    interruptCtrl_8_io_inputs[11] = ctrl_io_irqRise_valid[11];
  end

  always @(*) begin
    interruptCtrl_9_io_inputs[0] = ctrl_io_irqFall_valid[0];
    interruptCtrl_9_io_inputs[1] = ctrl_io_irqFall_valid[1];
    interruptCtrl_9_io_inputs[2] = ctrl_io_irqFall_valid[2];
    interruptCtrl_9_io_inputs[3] = ctrl_io_irqFall_valid[3];
    interruptCtrl_9_io_inputs[4] = ctrl_io_irqFall_valid[4];
    interruptCtrl_9_io_inputs[5] = ctrl_io_irqFall_valid[5];
    interruptCtrl_9_io_inputs[6] = ctrl_io_irqFall_valid[6];
    interruptCtrl_9_io_inputs[7] = ctrl_io_irqFall_valid[7];
    interruptCtrl_9_io_inputs[8] = ctrl_io_irqFall_valid[8];
    interruptCtrl_9_io_inputs[9] = ctrl_io_irqFall_valid[9];
    interruptCtrl_9_io_inputs[10] = ctrl_io_irqFall_valid[10];
    interruptCtrl_9_io_inputs[11] = ctrl_io_irqFall_valid[11];
  end

  always @(*) begin
    ctrl_io_irqHigh_pending[0] = interruptCtrl_6_io_pendings[0];
    ctrl_io_irqHigh_pending[1] = interruptCtrl_6_io_pendings[1];
    ctrl_io_irqHigh_pending[2] = interruptCtrl_6_io_pendings[2];
    ctrl_io_irqHigh_pending[3] = interruptCtrl_6_io_pendings[3];
    ctrl_io_irqHigh_pending[4] = interruptCtrl_6_io_pendings[4];
    ctrl_io_irqHigh_pending[5] = interruptCtrl_6_io_pendings[5];
    ctrl_io_irqHigh_pending[6] = interruptCtrl_6_io_pendings[6];
    ctrl_io_irqHigh_pending[7] = interruptCtrl_6_io_pendings[7];
    ctrl_io_irqHigh_pending[8] = interruptCtrl_6_io_pendings[8];
    ctrl_io_irqHigh_pending[9] = interruptCtrl_6_io_pendings[9];
    ctrl_io_irqHigh_pending[10] = interruptCtrl_6_io_pendings[10];
    ctrl_io_irqHigh_pending[11] = interruptCtrl_6_io_pendings[11];
  end

  always @(*) begin
    ctrl_io_irqLow_pending[0] = interruptCtrl_7_io_pendings[0];
    ctrl_io_irqLow_pending[1] = interruptCtrl_7_io_pendings[1];
    ctrl_io_irqLow_pending[2] = interruptCtrl_7_io_pendings[2];
    ctrl_io_irqLow_pending[3] = interruptCtrl_7_io_pendings[3];
    ctrl_io_irqLow_pending[4] = interruptCtrl_7_io_pendings[4];
    ctrl_io_irqLow_pending[5] = interruptCtrl_7_io_pendings[5];
    ctrl_io_irqLow_pending[6] = interruptCtrl_7_io_pendings[6];
    ctrl_io_irqLow_pending[7] = interruptCtrl_7_io_pendings[7];
    ctrl_io_irqLow_pending[8] = interruptCtrl_7_io_pendings[8];
    ctrl_io_irqLow_pending[9] = interruptCtrl_7_io_pendings[9];
    ctrl_io_irqLow_pending[10] = interruptCtrl_7_io_pendings[10];
    ctrl_io_irqLow_pending[11] = interruptCtrl_7_io_pendings[11];
  end

  always @(*) begin
    ctrl_io_irqRise_pending[0] = interruptCtrl_8_io_pendings[0];
    ctrl_io_irqRise_pending[1] = interruptCtrl_8_io_pendings[1];
    ctrl_io_irqRise_pending[2] = interruptCtrl_8_io_pendings[2];
    ctrl_io_irqRise_pending[3] = interruptCtrl_8_io_pendings[3];
    ctrl_io_irqRise_pending[4] = interruptCtrl_8_io_pendings[4];
    ctrl_io_irqRise_pending[5] = interruptCtrl_8_io_pendings[5];
    ctrl_io_irqRise_pending[6] = interruptCtrl_8_io_pendings[6];
    ctrl_io_irqRise_pending[7] = interruptCtrl_8_io_pendings[7];
    ctrl_io_irqRise_pending[8] = interruptCtrl_8_io_pendings[8];
    ctrl_io_irqRise_pending[9] = interruptCtrl_8_io_pendings[9];
    ctrl_io_irqRise_pending[10] = interruptCtrl_8_io_pendings[10];
    ctrl_io_irqRise_pending[11] = interruptCtrl_8_io_pendings[11];
  end

  always @(*) begin
    ctrl_io_irqFall_pending[0] = interruptCtrl_9_io_pendings[0];
    ctrl_io_irqFall_pending[1] = interruptCtrl_9_io_pendings[1];
    ctrl_io_irqFall_pending[2] = interruptCtrl_9_io_pendings[2];
    ctrl_io_irqFall_pending[3] = interruptCtrl_9_io_pendings[3];
    ctrl_io_irqFall_pending[4] = interruptCtrl_9_io_pendings[4];
    ctrl_io_irqFall_pending[5] = interruptCtrl_9_io_pendings[5];
    ctrl_io_irqFall_pending[6] = interruptCtrl_9_io_pendings[6];
    ctrl_io_irqFall_pending[7] = interruptCtrl_9_io_pendings[7];
    ctrl_io_irqFall_pending[8] = interruptCtrl_9_io_pendings[8];
    ctrl_io_irqFall_pending[9] = interruptCtrl_9_io_pendings[9];
    ctrl_io_irqFall_pending[10] = interruptCtrl_9_io_pendings[10];
    ctrl_io_irqFall_pending[11] = interruptCtrl_9_io_pendings[11];
  end
  ...
  always @(posedge _zz_1) begin
    if(!_zz_2) begin
      peripherals_gpio0Ctrl_interruptCtrl_6_io_masks_driver <= 12'h0;
      peripherals_gpio0Ctrl_interruptCtrl_7_io_masks_driver <= 12'h0;
      peripherals_gpio0Ctrl_interruptCtrl_8_io_masks_driver <= 12'h0;
      peripherals_gpio0Ctrl_interruptCtrl_9_io_masks_driver <= 12'h0;
      _zz_io_bus_PRDATA <= 1'b0;
      _zz_io_bus_PRDATA_2 <= 1'b0;
      _zz_io_bus_PRDATA_4 <= 1'b0;
      _zz_io_bus_PRDATA_6 <= 1'b0;
      ...
      case(io_bus_PADDR)
        12'h01c : begin
          if(_zz_io_bus_PSLVERROR_2) begin
            peripherals_gpio0Ctrl_interruptCtrl_6_io_masks_driver <= io_bus_PWDATA[11 : 0];
          end
        end
        12'h024 : begin
          if(_zz_io_bus_PSLVERROR_2) begin
            peripherals_gpio0Ctrl_interruptCtrl_7_io_masks_driver <= io_bus_PWDATA[11 : 0];
          end
        end
        12'h02c : begin
          if(_zz_io_bus_PSLVERROR_2) begin
            peripherals_gpio0Ctrl_interruptCtrl_8_io_masks_driver <= io_bus_PWDATA[11 : 0];
          end
        end
        12'h034 : begin
          if(_zz_io_bus_PSLVERROR_2) begin
            peripherals_gpio0Ctrl_interruptCtrl_9_io_masks_driver <= io_bus_PWDATA[11 : 0];
          end
        end
        12'h010 : begin
          if(_zz_io_bus_PSLVERROR_2) begin
...
module Axi4SharedDecoder (
  ...
  assign decodedCmdSels = {{((io_input_arw_payload_addr & (~ 32'h00ffffff)) == 32'hf0000000),((io_input_arw_payload_addr & (~ 32'h0000001f)) == 32'h80000000)},(((io_input_arw_payload_addr & (~ 32'h007fffff)) == 32'ha0000000) && (! io_input_arw_payload_write))};
...
module Axi4ReadOnlyDecoder (
  ...
  assign decodedCmdSels = {(((io_input_ar_payload_addr & (~ 32'h007fffff)) == 32'ha0000000) && io_input_ar_valid),(((io_input_ar_payload_addr & (~ 32'h0000001f)) == 32'h80000000) && io_input_ar_valid)};
...
module Axi4ReadOnlySpiXipController (
  ...
  localparam CmdMode_DATA = 1'd0;
  localparam CmdMode_CS = 1'd1;

  wire       [1:0]    spiControllerCtrl_1_io_pendingInterrupts;
  ...
  wire       [31:0]   ipIdentificationCtrl_6_io_header;
  wire       [31:0]   ipIdentificationCtrl_6_io_version;
  ...
  SpiControllerCtrl spiControllerCtrl_1 (
    ...
    .io_pendingInterrupts    (spiControllerCtrl_1_io_pendingInterrupts[1:0]  ), //i
  ...
  IpIdentificationCtrl_5 ipIdentificationCtrl_6 (
    .io_header  (ipIdentificationCtrl_6_io_header[31:0] ), //o
    .io_version (ipIdentificationCtrl_6_io_version[31:0]), //o
    ._zz_1      (_zz_1                                  ), //i
    ._zz_2      (_zz_2                                  )  //i
  );
  `ifndef SYNTHESIS
  ...
  always @(*) begin
    ...
    case(io_bus_PADDR)
      12'h0 : begin
        io_bus_PRDATA[31 : 0] = ipIdentificationCtrl_6_io_header;
      end
      12'h004 : begin
        io_bus_PRDATA[31 : 0] = ipIdentificationCtrl_6_io_version;
      end
      12'h008 : begin
...
module Axi4SharedOnChipRam (
  ...
  reg        [4:0]    unburstify_result_payload_fragment_addr;
  ...
  reg        [4:0]    unburstify_buffer_transaction_addr;
  ...
  wire       [4:0]    stage0_payload_fragment_addr;
  wire       [3:0]    stage0_payload_fragment_id;
  wire       [2:0]    stage0_payload_fragment_size;
  wire       [1:0]    stage0_payload_fragment_burst;
  wire                stage0_payload_fragment_write;
  wire       [2:0]    _zz_io_axi_r_payload_data;
  wire                stage0_fire;
  wire       [31:0]   _zz_io_axi_r_payload_data_1;
  wire                stage1_valid;
  wire                stage1_ready;
  wire                stage1_payload_last;
  wire       [4:0]    stage1_payload_fragment_addr;
  ...
  reg        [4:0]    stage0_rData_fragment_addr;
  ...
  assign _zz_Axi4Incr_base_1 = unburstify_buffer_transaction_addr[4 : 0];
  assign _zz_Axi4Incr_base = {7'd0, _zz_Axi4Incr_base_1};
  ...
  always @(*) begin
    case(unburstify_buffer_transaction_burst)
      ...
      2'b10 : begin
        Axi4Incr_result = _zz_Axi4Incr_result[4:0];
      end
      default : begin
        Axi4Incr_result = _zz_Axi4Incr_result_14[4:0];
      end
    endcase
  end
  ...
  assign _zz_io_axi_r_payload_data = stage0_payload_fragment_addr[4 : 2];
  ...
  always @(posedge _zz_2) begin
    if(unburstify_result_ready) begin
      ...
      unburstify_buffer_transaction_addr[4 : 0] <= Axi4Incr_result[4 : 0];
    end
    if(!unburstify_buffer_valid) begin
      if(when_Axi4Channel_l322) begin
        if(unburstify_result_ready) begin
...
module PinmuxCtrl (
  ...
  always @(*) begin
    case(io_options_4)
      1'b0 : begin
        _zz_io_pins_write_4 = io_inputs_write[18];
      end
      default : begin
  ...
  always @(*) begin
    case(io_options_4)
      1'b0 : begin
        _zz_io_pins_writeEnable_4 = io_inputs_writeEnable[18];
      end
      default : begin
  ...
  always @(*) begin
    case(io_options_5)
      1'b0 : begin
        _zz_io_pins_write_5 = io_inputs_write[19];
      end
      default : begin
  ...
  always @(*) begin
    case(io_options_5)
      1'b0 : begin
        _zz_io_pins_writeEnable_5 = io_inputs_writeEnable[19];
      end
      default : begin
  ...
  always @(*) begin
    case(io_options_6)
      1'b0 : begin
        _zz_io_pins_write_6 = io_inputs_write[15];
      end
      default : begin
  ...
  always @(*) begin
    case(io_options_6)
      1'b0 : begin
        _zz_io_pins_writeEnable_6 = io_inputs_writeEnable[15];
      end
      default : begin
  ...
  always @(*) begin
    case(io_options_7)
      1'b0 : begin
        _zz_io_pins_write_7 = io_inputs_write[16];
      end
      default : begin
  ...
  always @(*) begin
    case(io_options_7)
      1'b0 : begin
        _zz_io_pins_writeEnable_7 = io_inputs_writeEnable[16];
      end
      default : begin
  ...
  always @(*) begin
    case(io_options_9)
      1'b0 : begin
        _zz_io_pins_write_9 = io_inputs_write[12];
      end
      default : begin
  ...
  always @(*) begin
    case(io_options_9)
      1'b0 : begin
        _zz_io_pins_writeEnable_9 = io_inputs_writeEnable[12];
      end
      default : begin
  ...
  always @(*) begin
    case(io_options_10)
      1'b0 : begin
        _zz_io_pins_write_10 = io_inputs_write[13];
      end
      default : begin
  ...
  always @(*) begin
    case(io_options_10)
      1'b0 : begin
        _zz_io_pins_writeEnable_10 = io_inputs_writeEnable[13];
      end
      default : begin
  ...
  always @(*) begin
    case(io_options_11)
      1'b0 : begin
        _zz_io_pins_write_11 = io_inputs_write[14];
      end
      default : begin
  ...
  always @(*) begin
    case(io_options_11)
      1'b0 : begin
        _zz_io_pins_writeEnable_11 = io_inputs_writeEnable[14];
      end
      default : begin
...
module UartCtrl (
  ...
  UartCtrlTx tx (
    ...
    .io_samplingTick      (clockDivider_5_io_tick        ), //i
  ...
  always @(posedge _zz_1) begin
    if(!_zz_2) begin
      ...
      if(io_channels_0_enable) begin
        ...
        if(clockDivider_5_io_tick) begin
...
module PioCtrl (
  ...
  localparam fsm_enumDef_stateHigh = 3'd2;
  localparam fsm_enumDef_stateLow = 3'd3;
  localparam fsm_enumDef_stateWait = 3'd4;
  localparam fsm_enumDef_stateRead = 3'd5;

  reg                 clockDivider_5_io_reload;
  ...
  ClockDivider_2 clockDivider_5 (
    .io_value  (io_config_clockDivider[19:0]), //i
    .io_reload (clockDivider_5_io_reload    ), //i
    .io_tick   (clockDivider_5_io_tick      ), //o
    ._zz_1     (_zz_1                       ), //i
    ._zz_2     (_zz_2                       )  //i
  );
  ...
  always @(*) begin
    case(fsm_stateReg)
      ...
      fsm_enumDef_stateHigh : fsm_stateReg_string = "stateHigh";
      fsm_enumDef_stateLow : fsm_stateReg_string = "stateLow ";
      fsm_enumDef_stateWait : fsm_stateReg_string = "stateWait";
      fsm_enumDef_stateRead : fsm_stateReg_string = "stateRead";
  ...
  always @(*) begin
    case(fsm_stateNext)
      ...
      fsm_enumDef_stateHigh : fsm_stateNext_string = "stateHigh";
      fsm_enumDef_stateLow : fsm_stateNext_string = "stateLow ";
      fsm_enumDef_stateWait : fsm_stateNext_string = "stateWait";
      fsm_enumDef_stateRead : fsm_stateNext_string = "stateRead";
  ...
  always @(*) begin
    clockDivider_5_io_reload = 1'b0;
    if(when_StateMachine_l253) begin
      clockDivider_5_io_reload = 1'b1;
    end
  ...
  always @(*) begin
    ...
    case(fsm_stateReg)
      ...
      fsm_enumDef_stateHigh : begin
      end
      fsm_enumDef_stateLow : begin
      end
      fsm_enumDef_stateWait : begin
      end
      fsm_enumDef_stateRead : begin
      end
      default : begin
        fsm_wantStart = 1'b1;
      end
  ...
  assign _zz_when_StateMachine_l237 = (fsm_stateReg == fsm_enumDef_stateWait);
  assign _zz_when_StateMachine_l237_1 = (fsm_stateReg == fsm_enumDef_stateRead);
  assign _zz_when_StateMachine_l237_2 = (fsm_stateNext == fsm_enumDef_stateWait);
  assign _zz_when_StateMachine_l237_3 = (fsm_stateNext == fsm_enumDef_stateRead);
  always @(*) begin
        ...
        if(io_commands_valid) begin
          case(io_commands_payload_command)
            CommandType_HIGH : begin
              fsm_stateNext = fsm_enumDef_stateHigh;
            end
            CommandType_LOW : begin
              fsm_stateNext = fsm_enumDef_stateLow;
            end
            CommandType_WAIT_1 : begin
              fsm_stateNext = fsm_enumDef_stateWait;
            end
            default : begin
              fsm_stateNext = fsm_enumDef_stateRead;
            end
          endcase
        end
      end
  ...
  assign when_StateMachine_l237 = ((fsm_stateReg == fsm_enumDef_stateHigh) && (! (fsm_stateNext == fsm_enumDef_stateHigh)));
  assign when_StateMachine_l237_1 = ((fsm_stateReg == fsm_enumDef_stateLow) && (! (fsm_stateNext == fsm_enumDef_stateLow)));
...
module I2cControllerCtrl (
  ...
  ClockDivider_4 ctrl_clockDivider (
...
//InterruptCtrl_5 replaced by InterruptCtrl_2

//InterruptCtrl_4 replaced by InterruptCtrl_2

//InterruptCtrl_3 replaced by InterruptCtrl_2

module InterruptCtrl_2 (
...
module GpioCtrl (
  ...
  (* keep_hierarchy = "TRUE" *) BufferCC_1 io_gpio_pins_read_buffercc (
...
module SpiControllerCtrl (
  ...
  assign when_SpiControllerCtrl_l146 = ((io_cmd_payload_mode == CmdMode_CS) && io_cmd_payload_args[0]);
  assign when_SpiControllerCtrl_l150 = ((io_cmd_payload_mode == CmdMode_CS) && (! io_cmd_payload_args[0]));
  assign when_SpiControllerCtrl_l154 = (io_cmd_payload_mode == CmdMode_DATA);
  ...
  always @(posedge _zz_1) begin
    if(!_zz_2) begin
      ...
      _zz_io_rsp_valid <= ((io_cmd_fire && (io_cmd_payload_mode == CmdMode_DATA)) && io_cmd_payload_args[8]);
    end
  end
  ...
  always @(posedge _zz_1) begin
    _zz_io_spi_sclk <= (((io_cmd_valid && (io_cmd_payload_mode == CmdMode_DATA)) && (ctrl_dataCounter_value[0] ^ io_modeConfig_cpha)) ^ io_modeConfig_cpol);
...
//ClockDivider replaced by ClockDivider_2

//ClockDivider_1 replaced by ClockDivider_2
